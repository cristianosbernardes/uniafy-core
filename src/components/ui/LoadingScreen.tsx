...
export const LoadingScreen = () => {
    ...
    return (
        <div className="fixed inset-0 z-[50] flex flex-col items-center justify-center bg-[#050505] text-white overflow-hidden">
            ...
            <div
                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] blur-[120px] rounded-full animate-pulse pointer-events-none"
                style={{ backgroundColor: 'hsla(var(--primary), 0.05)' }}
            />
            ...
            <div className="relative z-10 flex flex-col items-center gap-8">
                ...
                <div className="relative">
                    ...
                    <div
                        className="absolute -inset-1 blur-lg opacity-50 animate-pulse"
                ...
                <div className="flex flex-col items-center gap-2">
                    ...
                    <div className="text-[10px] font-mono" style={{ color: 'hsla(var(--primary), 0.6)' }}>
